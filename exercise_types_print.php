...
require_once("include/exercise_types_variables.php");
...
$page_layouts["exercise_types_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "exercise_types" );
