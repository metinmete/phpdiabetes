...
require_once("include/Main_Dashboard_variables.php");
...
$layout = new TLayout("search", "CityBlueWave", "MobileBlueWave");
$layout->version = 2;
...
$page_layouts["Main_Dashboard_search"] = $layout;
...
$params['shortTableName'] = 'Main_Dashboard';
