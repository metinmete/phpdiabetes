...
require_once("include/medicationdata_variables.php");
...
$page_layouts["medicationdata_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "medicationdata" );
