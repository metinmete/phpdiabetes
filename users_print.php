...
$layout = new TLayout("print", "CoralAvenue", "MobileAvenue");
$layout->version = 2;
...
$layout->blocks["top"][] = "master";
$page_layouts["insulin_print"] = $layout;
...
$layout->blocks["top"][] = "master";
$page_layouts["readings_print"] = $layout;
...
$layout->blocks["top"][] = "master";
$page_layouts["meal_print"] = $layout;
...
$layout->blocks["top"][] = "master";
$page_layouts["exercise_print"] = $layout;
...
$layout->blocks["top"][] = "master";
$page_layouts["medication_print"] = $layout;
...
$layout->blocks["top"][] = "master";
$page_layouts["labtest_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "users" );
