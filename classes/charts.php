...
class Chart
{
	...
	function Chart(&$ch_array, $param)
	{
		...
		for ( $i=0; $i<count($this->chrt_array['parameters'])-1; $i++) 
		{
			...
			$this->setDataLabels(  $this->chrt_array['parameters'][$i], $TableName );
		}
	 ...
	 * @param Array params
	 */
	protected function setDataLabels( $params, $TableName )
	{
	...
	protected function isProjectDB()
	{
		...
		if("readings" == $this->chrt_array['tables'][0])
			return true;
		if("insulin" == $this->chrt_array['tables'][0])
			return true;
		if("meal" == $this->chrt_array['tables'][0])
			return true;
		if("exercise" == $this->chrt_array['tables'][0])
			return true;
		if("medication" == $this->chrt_array['tables'][0])
			return true;
		...
		if("test_types" == $this->chrt_array['tables'][0])
			return true;
		if("food_items" == $this->chrt_array['tables'][0])
			return true;
		if("exercise_types" == $this->chrt_array['tables'][0])
			return true;
		if("exam_type" == $this->chrt_array['tables'][0])
			return true;
		if("inject_type" == $this->chrt_array['tables'][0])
			return true;
		if("readings" == $this->chrt_array['tables'][0])
			return true;
		return false;
