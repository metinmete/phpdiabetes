...
{	
	...
	{
		if ( !$this->isDashboardElement() && !isMobile())
	...
	{
		$this->xt->assign("checkbox_column", $this->deleteAvailable() || $this->exportAvailable() || $this->inlineEditAvailable());
	...
	static function & createListPage($strTableName, $options)
	{
		...
		if ($params["mode"]==LIST_SIMPLE || $params["mode"]==LIST_MASTER)
