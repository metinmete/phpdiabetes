	...
	*/
	...
	function getDashMapIcon( $dashElementName, $data )
	{
		...
		if( $dashElementData["isMarkerIconCustom"] )
			return getDashMapCustomIcon( $dashElementName, $data );
...
function GetTableURL($table = "")
{
	...
	if("food_items" == $table)
		return "food_items";
	if("exercise_types" == $table)
		return "exercise_types";
	if("exam_type" == $table)
		return "exam_type";
	if("inject_type" == $table)
		return "inject_type";
	if("Readings Chart" == $table)
		return "Readings_Chart";
...
function GetTableByShort($shortTName = "")
{
	...
	if(!$shortTName)
		return false;
	if("readings" == $shortTName)
		return "readings";
	if("insulin" == $shortTName)
		return "insulin";
	if("meal" == $shortTName)
		return "meal";
	if("exercise" == $shortTName)
		return "exercise";
	if("medication" == $shortTName)
		return "medication";
	...
	if("food_items" == $shortTName)
		return "food_items";
	if("exercise_types" == $shortTName)
		return "exercise_types";
	if("exam_type" == $shortTName)
		return "exam_type";
	if("inject_type" == $shortTName)
		return "inject_type";
	if("Readings_Chart" == $shortTName)
		return "Readings Chart";
}
