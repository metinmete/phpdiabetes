...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("readings" == $this->xml_array['tables'][0])
			$isDB = true;
		if("insulin" == $this->xml_array['tables'][0])
			$isDB = true;
		if("meal" == $this->xml_array['tables'][0])
			$isDB = true;
		if("exercise" == $this->xml_array['tables'][0])
			$isDB = true;
		if("medication" == $this->xml_array['tables'][0])
			$isDB = true;
		...
		if("test_types" == $this->xml_array['tables'][0])
			$isDB = true;
		if("food_items" == $this->xml_array['tables'][0])
			$isDB = true;
		if("exercise_types" == $this->xml_array['tables'][0])
			$isDB = true;
		if("exam_type" == $this->xml_array['tables'][0])
			$isDB = true;
		if("inject_type" == $this->xml_array['tables'][0])
			$isDB = true;
		if("readings" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
