...
require_once("include/exam_type_variables.php");
...
$page_layouts["exam_type_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "exam_type" );
