...
require_once("include/Users_Report_variables.php");
...
$layout = new TLayout("report_print", "CityBlueWave", "MobileBlueWave");
$layout->version = 2;
...
$page_layouts["Users_Report_rprint"] = $layout;
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Users_Report.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("address1_fieldheader", true);
$xt->assign("address2_fieldheader", true);
$xt->assign("address3_fieldheader", true);
...
$xt->assign("phonetype_fieldheader", true);
$xt->assign("phonenumber_fieldheader", true);
