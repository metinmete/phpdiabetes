...
require_once("include/medicine_type_variables.php");
...
$page_layouts["medicine_type_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "medicine_type" );
