...
$page_layouts["exercise_detailspreview"] = $layout;
...
if($rowcount) 
{
	...
	//	duration - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("duration", $data, $keylink);
			$row["duration_value"] = $value;
			$format = $pSet->getViewFormat("duration");
			$class = "rnr-field-text";
			if($format==FORMAT_FILE) 
				$class = ' rnr-field-file'; 
			if($format==FORMAT_AUDIO)
			...
			if($format==FORMAT_CHECKBOX)
				$class = ' rnr-field-checkbox';
			if($format==FORMAT_NUMBER || IsNumberType($pSet->getFieldType("duration")))
				$class = ' rnr-field-number';
			$row["duration_class"] = $class;
	//	intensity - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("intensity", $data, $keylink);
			$row["intensity_value"] = $value;
			$format = $pSet->getViewFormat("intensity");
			$class = "rnr-field-text";
			if($format==FORMAT_FILE) 
				$class = ' rnr-field-file'; 
			if($format==FORMAT_AUDIO)
			...
			if($format==FORMAT_CHECKBOX)
				$class = ' rnr-field-checkbox';
			if($format==FORMAT_NUMBER || IsNumberType($pSet->getFieldType("intensity")))
				$class = ' rnr-field-number';
			$row["intensity_class"] = $class;
	//	comment - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template(GetTemplateName("exercise", "detailspreview"));
