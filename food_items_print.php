...
require_once("include/food_items_variables.php");
...
$page_layouts["food_items_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "food_items" );
