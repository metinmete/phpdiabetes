...
require_once("include/inject_type_variables.php");
...
$page_layouts["inject_type_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "inject_type" );
