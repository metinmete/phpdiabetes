...
require_once("include/insulintype_variables.php");
...
$page_layouts["insulintype_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "insulintype" );
