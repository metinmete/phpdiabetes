...
require_once("include/test_types_variables.php");
...
$page_layouts["test_types_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "test_types" );
