...
function getDashMapCustomIcon( $dashElementName, $data )
{
	$icon = "";
}
...
function GetLWWhere($field, $ptype, $table = "")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="readings" && $field=="sample_site")
	{
		return "hide = 'No'";
	}
				if($table=="insulin" && $field=="type")
	{
		return "hide = 'No'";
	}
				if($table=="insulin" && $field=="inject_type")
	{
		return "hide = 'No'";
	}
				if($table=="exercise" && $field=="time_period")
	{
		return "hide = 'No'";
	}
				if($table=="medication" && $field=="medication")
	{
		return "hide = 'No'";
	}
				if($table=="labtest" && $field=="type")
	{
		return "hide = 'No'";
	}
				if($table=="Readings Chart" && $field=="sample_site")
	{
		return "hide = 'No'";
	}
	return "";
...
function GetDefaultValue($field, $ptype, $table="")
{
				...
				if($table=="medicationdata" && $field=="hide")
	{
		return "hide = 0";
				...
				if($table=="test_types" && $field=="hide")
	{
		return "hide = 0'";
	}
				if($table=="food_items" && $field=="hide")
	{
		return "hide = 0";
	}
				if($table=="food_items" && $field=="fav")
	{
		return "hide = 0";
	}
				if($table=="exercise_types" && $field=="hide")
	{
		return "hide = 0";
	}
				if($table=="exam_type" && $field=="hide")
	{
		return "hide = 0";
	}
				if($table=="inject_type" && $field=="hide")
	{
		return "hide = 0";
	}
	return "";
