...
class tDAL
{
	var $tbldiabetes_at_localhost__exam_type;
	var $tbldiabetes_at_localhost__exercise;
	var $tbldiabetes_at_localhost__exercise_types;
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "exam_type", "varname" => "diabetes_at_localhost__exam_type", "altvarname" => "exam_type", "connId" => "diabetes_at_localhost", "schema" => "", "connName" => "diabetes at localhost");
		$this->lstTables[] = array("name" => "exercise", "varname" => "diabetes_at_localhost__exercise", "altvarname" => "exercise", "connId" => "diabetes_at_localhost", "schema" => "", "connName" => "diabetes at localhost");
		$this->lstTables[] = array("name" => "exercise_types", "varname" => "diabetes_at_localhost__exercise_types", "altvarname" => "exercise_types", "connId" => "diabetes_at_localhost", "schema" => "", "connName" => "diabetes at localhost");
