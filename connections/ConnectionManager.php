...
class ConnectionManager
{
	...
	{
		return $this->byId( "diabetes_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "diabetes_at_localhost";
		$data["connName"] = "diabetes at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;gehrenfeld;Ehyrag649!;;diabetes;;1"; //currently unused
		
		$this->_connectionsIdByName["diabetes at localhost"] = "diabetes_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "gehrenfeld";
		$data["ODBCPWD"] = "Ehyrag649!";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][1] = "gehrenfeld";
		$data["connInfo"][2] = "Ehyrag649!";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "diabetes";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=gehrenfeld;Pwd=Ehyrag649!;Database=diabetes;OPTION=3";
		$connectionsData["diabetes_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["readings"] = "diabetes_at_localhost";
		$connectionsIds["insulin"] = "diabetes_at_localhost";
		$connectionsIds["meal"] = "diabetes_at_localhost";
		...
		$connectionsIds["exam_type"] = "diabetes_at_localhost";
		$connectionsIds["inject_type"] = "diabetes_at_localhost";
		$connectionsIds["Readings Chart"] = "diabetes_at_localhost";
